...
exports.test_induceWitting = void 0;
const main_1 = require("../../main");
var should = require("should");
function test_induceWitting() {
    describe("induceWitting()", function () {
        ...
        const sa_athlete = (0, main_1.induceWitting)(athlete, getState);
...
exports.test_induceWitting = test_induceWitting;
;
